...
this.props,graduation=_props.graduation,maximumValue=_props.maximumValue,minimumValue=_props.minimumValue;
...
return(
_react2.default.createElement(_reactNative.View,{style:this.props.containerStyle,__source:{fileName:_jsxFileName,lineNumber:327}},
_react2.default.createElement(_reactNative.View,_extends({},other,{style:[mainStyles.container,style],onLayout:this._measureContainer,__source:{fileName:_jsxFileName,lineNumber:328}}),
_react2.default.createElement(_reactNative.View,{
style:[{backgroundColor:maximumTrackTintColor},mainStyles.track,trackStyle],
onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:329}}),
_react2.default.createElement(_reactNative.Animated.View,{style:[mainStyles.track,trackStyle,minimumTrackStyle],__source:{fileName:_jsxFileName,lineNumber:332}}),
graduationArray.filter(function(i){return!ignoredGraduations||!ignoredGraduations.includes(i+1);}).map(function(i){return(
_react2.default.createElement(_reactNative.View,{key:i,__source:{fileName:_jsxFileName,lineNumber:334}},
_react2.default.createElement(_reactNative.View,{
style:[
{backgroundColor:maximumTrackTintColor,marginTop:-(trackSize.height+GRADUATION_HEIGHT)/2},
mainStyles.graduation,graduationStyle,_extends({left:_this._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:335}}),
...
{width:_this.state.legendWidth[i],left:_this._getGraduationOffset(i)-_this.state.legendWidth[i]/2}],__source:{fileName:_jsxFileName,lineNumber:340}},
...
mainStyles.thumb,thumbStyle,_extends({left:thumbLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:348}}),
...
style:[{top:containerSize.height/2-trackSize.height-thumbSize.height-4},mainStyles.currentValueBubbleContainer,currentValueBubbleContainerStyle,_extends({left:currentValueBubbleLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:362}},
_react2.default.createElement(_reactNative.Text,{style:[mainStyles.currentValueBubble,currentValueBubbleTextStyle],__source:{fileName:_jsxFileName,lineNumber:365}},this.props.graduationLabel(this.props.value)))));
...
this.props,graduation=_props3.graduation,graduationStyle=_props3.graduationStyle,thumbStyle=_props3.thumbStyle,minimumValue=_props3.minimumValue,maximumValue=_props3.maximumValue;var _state2=



this.state,containerSize=_state2.containerSize,thumbSize=_state2.thumbSize;
...
_measureCurrentValueBubble:function _measureCurrentValueBubble(x){
...
return(
_react2.default.createElement(_reactNative.Text,{style:[{textAlign:'center'},this.props.graduationLabelStyle],__source:{fileName:_jsxFileName,lineNumber:634}},
this.props.graduationLabel(index)));


}
return _react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:639}});
},
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:652}}));
