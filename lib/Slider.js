...
_react2.default.createElement(_reactNative.View,{key:i,__source:{fileName:_jsxFileName,lineNumber:337}},
_react2.default.createElement(_reactNative.View,{
style:[
{backgroundColor:maximumTrackTintColor,marginTop:-(trackSize.height+GRADUATION_HEIGHT)/2},
mainStyles.graduation,graduationStyle,_extends({left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:338}}),
...
{width:_this2.state.legendWidth[i],left:_this2._getGraduationOffset(i)-_this2.state.legendWidth[i]/2}],__source:{fileName:_jsxFileName,lineNumber:343}},
...
mainStyles.thumb,thumbStyle,_extends({left:thumbLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:351}}),
...
style:[{top:containerSize.height/2-trackSize.height-thumbSize.height-4},mainStyles.currentValueBubbleContainer,currentValueBubbleContainerStyle,_extends({left:currentValueBubbleLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:365}},
_react2.default.createElement(_reactNative.Text,{style:[mainStyles.currentValueBubble,currentValueBubbleTextStyle],__source:{fileName:_jsxFileName,lineNumber:368}},this.props.graduationLabel(this.props.value)))));
...
return(
_react2.default.createElement(_reactNative.Text,{style:[{textAlign:'center'},_this3.props.graduationLabelStyle],__source:{fileName:_jsxFileName,lineNumber:643}},
_this3.props.graduationLabel(index)));


}
return _react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:648}});
};this.
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:661}}));
