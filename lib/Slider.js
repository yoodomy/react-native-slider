...
Slider=function(_React$Component){_inherits(Slider,_React$Component);function Slider(){var _ref;var _temp,_this,_ret;_classCallCheck(this,Slider);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_ref=Slider.__proto__||Object.getPrototypeOf(Slider)).call.apply(_ref,[this].concat(args))),_this),_this.
propTypes={
...
enableDirectTouch:_propTypes2.default.bool,
...
graduation:_propTypes2.default.number,
...
graduationLabel:_propTypes2.default.func,
...
{width:_propTypes2.default.number,height:_propTypes2.default.number}),
...
graduationLabelStyle:_reactNative.Text.propTypes.style,
graduationLabelContainerStyle:_reactNative.View.propTypes.style,
...
animationConfig:_propTypes2.default.object},_this.
...
return(
_react2.default.createElement(_reactNative.Text,{style:[{textAlign:'center'},this.props.graduationLabelStyle],__source:{fileName:_jsxFileName,lineNumber:638}},
this.props.graduationLabel(index)));


}
return _react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:643}});
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:656}}));
