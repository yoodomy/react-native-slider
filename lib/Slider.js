...
_react2.default.createElement(_reactNative.View,{style:_extends({backgroundColor:maximumTrackTintColor,marginTop:-(trackSize.height+GRADUATION_HEIGHT-2)/2,width:2,height:GRADUATION_HEIGHT-2,left:_this2._getGraduationOffset(i)},valueVisibleStyle),__source:{fileName:_jsxFileName,lineNumber:375}})));}),
...
return(
_react2.default.createElement(_reactNative.Text,{style:[{textAlign:'center'},_this3.props.graduationLabelStyle],__source:{fileName:_jsxFileName,lineNumber:659}},
_this3.props.graduationLabel(index)));


}
return _react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:664}});
};this.
...
pointerEvents:'none',__source:{fileName:_jsxFileName,lineNumber:677}}));
