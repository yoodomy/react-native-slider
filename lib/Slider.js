...
return(
_react2.default.createElement(_reactNative.View,{style:this.props.containerStyle,__source:{fileName:_jsxFileName,lineNumber:338}},
_react2.default.createElement(_reactNative.View,_extends({},other,{style:[mainStyles.container,style],onLayout:this._measureContainer,__source:{fileName:_jsxFileName,lineNumber:339}}),
_react2.default.createElement(_reactNative.View,{
style:[{backgroundColor:maximumTrackTintColor},mainStyles.track,trackStyle],
onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:340}}),
_react2.default.createElement(_reactNative.Animated.View,{style:[mainStyles.track,trackStyle,minimumTrackStyle],__source:{fileName:_jsxFileName,lineNumber:343}}),
graduationArray.filter(function(i){return!ignoredGraduations||!ignoredGraduations.includes(i+1);}).map(function(i){return(
_react2.default.createElement(_reactNative.View,{key:i,__source:{fileName:_jsxFileName,lineNumber:345}},
_react2.default.createElement(_reactNative.View,{
style:[
{backgroundColor:maximumTrackTintColor,marginTop:-(trackSize.height+GRADUATION_HEIGHT)/2},
mainStyles.graduation,graduationStyle,_extends({left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:346}}),
...
{width:_this2.state.legendWidth[i],left:_this2._getGraduationOffset(i)-_this2.state.legendWidth[i]/2}],__source:{fileName:_jsxFileName,lineNumber:351}},
...
mainStyles.thumb,thumbStyle,_extends({left:thumbLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:359}}),


_react2.default.createElement(_reactNative.View,_extends({
style:[defaultStyles.touchArea,touchOverflowStyle]},
this._panResponder.panHandlers,{__source:{fileName:_jsxFileName,lineNumber:366}}),
...
style:[{top:containerSize.height/2-trackSize.height-thumbSize.height-4},mainStyles.currentValueBubbleContainer,currentValueBubbleContainerStyle,_extends({left:currentValueBubbleLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:373}},
_react2.default.createElement(_reactNative.Text,{style:[mainStyles.currentValueBubble,currentValueBubbleTextStyle],__source:{fileName:_jsxFileName,lineNumber:376}},this.props.graduationLabel(this.props.value)))));
...
if(_this3._thumbHitTest(e)||!_this3.props.enableDirectTouch){
return;
}
...
if(_this3.props.disabled||!_this3.state.moving){
return;
}
...
return(
_react2.default.createElement(_reactNative.Text,{style:[{textAlign:'center'},_this3.props.graduationLabelStyle],__source:{fileName:_jsxFileName,lineNumber:645}},
