...
props){var
graduation=props.graduation,maximumValue=props.maximumValue,minimumValue=props.minimumValue;
...
var currentValueBubbleOverflow=
...
fill(0).
forEach(function(value,index){return graduationArray.push(index);});

return(
_react2.default.createElement(_reactNative.View,{style:this.props.containerStyle,__source:{fileName:_jsxFileName,lineNumber:363}},
_react2.default.createElement(_reactNative.View,_extends({},
other,{
style:[mainStyles.container,style],
onLayout:this._measureContainer,__source:{fileName:_jsxFileName,lineNumber:364}}),
...
onLayout:this._measureTrack,__source:{fileName:_jsxFileName,lineNumber:369}}),

_react2.default.createElement(_reactNative.Animated.View,{
style:[mainStyles.track,trackStyle,minimumTrackStyle],__source:{fileName:_jsxFileName,lineNumber:377}}),
...
mainStyles.thumb,
thumbStyle,_extends({
left:thumbLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:381}}),


_react2.default.createElement(_reactNative.View,_extends({
style:[defaultStyles.touchArea,touchOverflowStyle]},
this._panResponder.panHandlers,{__source:{fileName:_jsxFileName,lineNumber:393}}),
...
position:"absolute"},__source:{fileName:_jsxFileName,lineNumber:403}},
...
graduationStyle,
Math.round(active)===i&&{backgroundColor:'transparent'},_extends({
left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:410}}),
...
{
width:_this2.state.legendWidth[i],
left:
_this2._getGraduationOffset(i)-
_this2.state.legendWidth[i]/2}],__source:{fileName:_jsxFileName,lineNumber:422}},
...
style:{
top:containerSize.height/2+trackSize.height/2,
position:"absolute"},__source:{fileName:_jsxFileName,lineNumber:440}},
...
graduationStyle,
Math.round(active)===i&&{backgroundColor:'transparent'},_extends({
left:_this2._getGraduationOffset(i)},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:447}})));}),
...
currentValueBubbleContainerStyle,_extends({
left:currentValueBubbleLeft},valueVisibleStyle)],__source:{fileName:_jsxFileName,lineNumber:464}},


_react2.default.createElement(_reactNative.Text,{
style:[
mainStyles.currentValueBubble,
currentValueBubbleTextStyle],__source:{fileName:_jsxFileName,lineNumber:479}},
...
var graduationStyleObject=
graduationStyle&&_reactNative.StyleSheet.flatten(graduationStyle);
graduationOffset-=
...
if(
_this3._containerSize&&
_this3._trackSize&&
_this3._thumbSize&&(
_this3.props.currentValueBubble&&_this3._currentValueBubbleSize||
!_this3.props.currentValueBubble))
{
_this3.setState({
...
return(
(value-_this3.props.minimumValue)/(
_this3.props.maximumValue-_this3.props.minimumValue));
...
return(
ratio*(_this3.state.containerSize.width-_this3.state.thumbSize.width));
...
return Math.max(
_this3.props.minimumValue,
Math.min(
_this3.props.maximumValue,
_this3.props.minimumValue+
Math.round(
ratio*(_this3.props.maximumValue-_this3.props.minimumValue)/
_this3.props.step)*
...
_this3._getThumbLeft(_this3._getCurrentValue())+
...
return(
_react2.default.createElement(_reactNative.Text,{
style:[{textAlign:"center"},_this3.props.graduationLabelStyle],__source:{fileName:_jsxFileName,lineNumber:804}},

_this3.props.graduationLabel(index)));


}
return _react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:811}});
};this.
...
pointerEvents:"none",__source:{fileName:_jsxFileName,lineNumber:824}}));
